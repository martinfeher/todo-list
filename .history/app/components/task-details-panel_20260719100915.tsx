          ...
          {task && (
            <div className="ml-4 flex items-center overflow-hidden rounded">
              <button
                ...
                disabled={!canUndo}
                onClick={handleUndo}
                className="flex h-7 min-w-[2.25rem] items-center justify-center px-2.5 text-zinc-500 transition-colors hover:bg-zinc-200 hover:text-zinc-800 cursor-pointer disabled:cursor-not-allowed disabled:opacity-40 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100 "
              >

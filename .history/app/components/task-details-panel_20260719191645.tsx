          ...
          {task ? (
            <>
              <button
                ...
                className="flex cursor-pointer items-center gap-1 rounded-2xl bg-[#e8eff2] pl-3.5 pr-3 py-1.5 text-[13px] font-semibold uppercase tracking-wide text-zinc-700 transition-colors hover:bg-[#e0e2e5] dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
              >
                <span>Date</span>
                <PlusIcon className="ml-1 size-3 text-[#5F5F5F]" />
              </button>
              {task.dueDate && formatDueDateLabel(task.dueDate) && (
                <p className="text-sm text-zinc-500 dark:text-zinc-400 cursor-pointer" onClick={handleDateButtonClick}>

        ...
        <div className="flex flex-col gap-3 px-4 pb-4">
          ...
          <div ref={editorWrapperRef} className="relative overflow-visible">
            ...
            {lineControls && (
              <div
                ref={lineControlsRef}
                className="pointer-events-auto absolute left-1 z-10 flex -translate-y-1/2 items-center gap-0.5 mr-2"
              ...
              >
                <button
                  ...
                  className="flex size-4 items-center justify-center rounded text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-zinc-200"
                ...
                <button
                  ...
                  title="Line options"
                  className="flex size-4 cursor-grab items-center justify-center rounded text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-zinc-200"
                  onMouseDown={(event) => event.preventDefault()}
                >

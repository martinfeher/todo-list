        ...
        {days.map((day, index) => {
          ...
          return (
            <button
              ...
              className="flex h-9 flex-col items-center justify-center rounded-md transition-colors hover:bg-zinc-100 dark:hover:bg-zinc-800"
            >
              <span
      ...
      <div className="border-b border-zinc-200 px-3 py-2.5 dark:border-zinc-700">
        ...
        {dateInputError && (
          <p className="mt-1 text-xs text-red-500">
            Enter a valid future date, e.g. 07/05/2026
          </p>
        )}
      </div>

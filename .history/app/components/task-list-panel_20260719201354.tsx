          ...
          <div className="flex items-center gap-2 px-4 py-3">
            ...
            <div className="relative shrink-0" ref={sortMenuRef}>
              <button
                ...
                className="flex size-[35px] items-center justify-center rounded-lg border border-zinc-200 text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-800 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
              >
                <BiSortAlt2 className="size-[18px] text-[#9b9b9b]" />
              </button>

          ...
          {task && (
            <div className="ml-4 flex items-center overflow-hidden rounded">
              <button
                ...
                disabled={!canUndo}
                onClick={handleUndo}
                className="flex h-7 min-w-[2.25rem] items-center justify-center border-r border-zinc-200 px-2.5 text-zinc-500 transition-colors hover:bg-zinc-200 hover:text-zinc-800 disabled:cursor-not-allowed disabled:opacity-40 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
              >
                <BiUndo className="size-4" />
              </button>
              <button
                type="button"
                aria-label="Redo"
                ...
                disabled={!canRedo}
                onClick={handleRedo}
                className="flex h-7 min-w-[2.25rem] items-center justify-center px-2.5 text-zinc-500 transition-colors hover:bg-zinc-200 hover:text-zinc-800 disabled:cursor-not-allowed disabled:opacity-40 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
              >
                <BiRedo className="size-4" />
              </button>
            </div>
          )}
        </div>

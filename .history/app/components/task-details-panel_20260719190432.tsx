        ...
        <div className="flex items-center gap-3">
          {task ? (
            <button
              ...
              className="flex items-center gap-1 rounded-md bg-[#ededed] px-2 py-1 text-sm font-semibold uppercase tracking-wide text-zinc-700 transition-colors hover:bg-[#f9ddd6] dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
            >
              <span>Date</span>

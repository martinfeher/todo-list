          ...
          <div className="flex items-center gap-2 px-4 py-3">
            ...
            <div className="relative shrink-0" ref={sortMenuRef}>
              <button
                ...
                className="flex size-[3px] items-center justify-center rounded-md border border-zinc-300 text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-800 dark:border-zinc-700 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
              >

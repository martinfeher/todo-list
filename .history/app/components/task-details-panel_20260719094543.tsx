    ...
    >
      <div className="flex items-center justify-between p-4">
        <div className="flex items-center gap-3">
          ...
          {task && (
            <div className="flex items-center gap-0.5 ml-">
              <button
                type="button"
                aria-label="Undo"
                title="Undo (Ctrl+Z)"
                disabled={!canUndo}
                onClick={handleUndo}
                className="flex size-7 items-center justify-center rounded text-zinc-500 transition-colors hover:bg-zinc-200 hover:text-zinc-800 disabled:cursor-not-allowed disabled:opacity-40 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
              >

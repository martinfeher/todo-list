        ...
        <div className="flex items-center gap-3">
          {task ? (
            <button
              ...
              className="flex items-center gap-1 rounded-2xl bg-[#eceeef] px-3 py-1.5 text-sm font-semibold uppercase tracking-wide text-zinc-700 transition-colors hover:bg-[#e2e2e2] dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
            >
              <span>Date</span>

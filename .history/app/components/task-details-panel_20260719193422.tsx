          ...
          {task ? (
            <>
              <button
                ...
                className="flex cursor-pointer items-center gap-1 rounded-2xl bg-[#e8eff2] pl-3.5 pr-3 py- text-[12px] font-semibold uppercase tracking-wide text-zinc-700 transition-colors hover:bg-[#e0e2e5] dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
              >
                <span>Date</span>

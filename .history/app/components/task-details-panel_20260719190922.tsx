        ...
        <div className="flex items-center gap-3">
          {task ? (
            <button
              ...
              className="flex items-center gap-1 rounded-2xl bg-[#e8eff2] px-3 py-1.5 text-[12px] font-semibold uppercase tracking-wide text-zinc-700 transition-colors hover:bg-[#e0e2e5] dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700 cursor-pointer"
            >
              <span>Date</span>
              <PlusIcon className="size-4 ml-1 text-[#5F5F5F]" />
            </button>
          ) : (
